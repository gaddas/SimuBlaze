namespace IDE.CPU.Commands
{
    ...
    [Command(Command = "AND")]
    internal class cmdAND : CommandBaseDoubleOperand
    {
        public cmdAND()
            : base()
        {
            base.commandString = "AND";
        }
        ...
        {
            //001010XXXXKKKKKKKK
            var bits = "001010" + assembler.RegisterToBits4(register) + assembler.LiteralToBits8(literal);
            assembler.Instruction(assembler.address, bits);
            assembler.address++;
        }
    }
